    ...
    <div class="main" style="width: 1000px;margin: 180px auto 0 auto">
      <div style="width: 100%">
        ...
        <p class="board-content">
          榜单规则：将国内尚未商业的影片，按照期待人数从高到低排列取前10名，每天上午10点更新。相关数据来源于“天天专业版”及“天天电影库”。
        </p>
      </div>
      <dl style="width: 1194px; margin-top: 50px">
        <dd style="width: 100%">
          <el-row v-for="(item,index) in this.exceptedMovie" :key="index" style="margin: 20px">
            <div>
              ...
              <el-col :span="16" :offset="1"
                ...
                <div class="board-item-content">
                  ...
                  <div class="movie-item-number wish">
                    <p class="month-wish">总想看:&nbsp;&nbsp;
                      <span>
                      <span class="stonefont">{{ item.expect }}</span>
                    </span>人
                    </p>
                  </div>
                </div>
...
export default {
  ...
  mounted() {
    this.$axios({
      url: 'rank/getExcepted',
    }).then(res => this.exceptedMovie = res.data.data)
  }
}
</script>
